...
st.set_page_config(page_title="NEXA v11.2.2", layout="wide")
st.markdown("<h2>NEXA ATTENDANCE PRO</h2><p style='color:#9CA3AF;font-size:12px'>V11.2.2 FINAL", unsafe_allow_html=True)
...
def cek_keterangan(tgl_dt, jm_str="", jp_str="", jam_float=0, status="H"):
    ...
    if status in ['A','I','S','C','TL','GH','GHS','L']:
        mapping = {"A":"ALFA","I":"IZIN","S":"SAKIT","C":"CUTI","TL":"TUKAR LIBUR","GH":"GANTI HARI","GHS":"GANTI HARI SABTU","L":"SHIFT LIBUR"}
...
tab_absen, tab_edit, tab_admin, tab_rekap = st.tabs(["ABSEN","EDIT","ADMIN","REKAP"])
